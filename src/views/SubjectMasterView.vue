    ...
    <div v-if="!isLoading">
        ...
        <div v-if="!error">
            ...
            <div v-for="(subject, index) in subjectList" :key=index>
                ...
                <SubjectDetailComponent :name="subject.name" :code="subject.code" :course="getCourseIndex(subject.course)"
                    :pendingProposals="0" />
...
import SubjectDetailComponent from "@/components/subjects/SubjectDetailComponent.vue"
